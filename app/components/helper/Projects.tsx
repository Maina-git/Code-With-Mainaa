...
{
  id: 8,
  title: "MediTrack Hospital Landing Page",
  description:
    "A modern healthcare web application designed to provide patients with easy access to healthcare services, doctor information, hospital details, and contact support. The platform features a professional user interface, responsive design, reusable components, and modern Next.js architecture for an exceptional user experience.",
  link: "https://meditrack-hospital-landing-page-ofuf-nn6hredqf.vercel.app/",
  github: "https://github.com/Maina-git/Meditrack-Hospital-Landing-page-.git",
  image: "/images/Screenshot (281).png ",
  tools: [
    "Next.js",
    "React",
    "TypeScript",
